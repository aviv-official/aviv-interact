import {TelepathicElement} from "../telepathic-elements/telepathic-element/telepathic-element.js";
export default class AvivHeaderElement extends TelepathicElement{
    static describe(){ return `AvivHeaderElement is used to provide a consistent header that is databound and themeable`};
	constructor(){
        super(null,true);        
        this.headerText = `Welcome to AVIV`;
    }
    init(){return};
	async onReady(){
